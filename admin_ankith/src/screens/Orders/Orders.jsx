  ...
  <div key={index} className="order-item">
    ...
    <div>
      ...
      <p className='order-item-name'>
        {order.address ? `${order.address.first_name} ${order.address.last_name}` : "Unknown"}
      </p>
      <div className='order-item-address'>
        <p>{order.address ? `${order.address.street}, ` : ""}</p>
        <p>{order.address ? `${order.address.city}, ${order.address.state}, ${order.address.country}, ${order.address.zip_code}` : ""}</p>
      </div>
